CREATE DATABASE IF NOT EXISTS `timecampus` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `timecampus`;
-- 用户表
...
(
    ...
    `role`            varchar(20)  NOT NULL DEFAULT 'none' COMMENT '角色：super / admin / read / none',
