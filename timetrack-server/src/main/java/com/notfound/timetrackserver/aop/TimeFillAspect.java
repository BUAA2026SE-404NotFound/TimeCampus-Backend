package com.notfound.timetrackserver.aop;
...
public class TimeFillAspect {
    ...
    @Before("execution(* com.notfound.timetrackserver.mapper.*.insert*(..))")
    ...
    @Before("execution(* com.notfound.timetrackserver.mapper.*.update*(..))")
